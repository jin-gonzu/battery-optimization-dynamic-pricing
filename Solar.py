...
def readData(filename):
    ...
    if len(data) != 96:
        raise ValueError(f"Unerwartete Anzahl an Daten: {len(data)} statt 96")
    return data

values_kosten = readData("netztarif.log")
energyConsumption = readData("verbrauch.log")
values_pv = readData("pv.log")

battery_soc_initial = 35;
